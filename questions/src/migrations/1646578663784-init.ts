...
export class init1646578663784 implements MigrationInterface {
    name = 'init1646578663784'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "questions" ("id" SERIAL NOT NULL, "problem" text NOT NULL, "input_format" text NOT NULL, "output_format" text NOT NULL, "challenge_seed" text NOT NULL, "level" "public"."questions_level_enum" NOT NULL DEFAULT 'easy', "points" integer NOT NULL DEFAULT '0', "is_premium" boolean NOT NULL DEFAULT false, CONSTRAINT "CHK_2f5819613064f43f7bde5c0992" CHECK (points >= 0), CONSTRAINT "PK_08a6d4b0f49ff300bf3a0ca60ac" PRIMARY KEY ("id"))`);
